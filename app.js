...
mongoose.connect(dbUrl, { //keep ''mongodb://localhost:27017/yelp-camp' and then replace with dbUrl when deploying
...
const scriptSrcUrls = [
    ...
    "https://res.cloudinary.com/aleck/"
];
const styleSrcUrls = [
...
const fontSrcUrls = [ "https://res.cloudinary.com/aleck/" ];
...
app.use(
    helmet.contentSecurityPolicy({
        directives : {
            ...
            workerSrc  : [ "'self'", "blob:" ],
            objectSrc  : [],
            imgSrc     : [ //add below any image urls you want allowed
                "'self'",
                "blob:",
                "data:",
